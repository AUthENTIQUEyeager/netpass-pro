...
import { CheckCircle, Copy, Download, Wifi, AlertCircle } from 'lucide-react';
    ...
    if (commande.statut === 'en_attente') return (
      <div className="min-h-screen bg-[#0f0f0f] flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <p className="text-zinc-500 text-sm mb-6">Le paiement n'a pas encore ete confirme.</p>
    ...
    <div className="min-h-screen bg-[#0f0f0f] text-white">
      ...
      <div className="relative z-10 max-w-md mx-auto px-6 pt-24 pb-20">
        <div className="text-center mb-8">
          <div className="w-12 h-12 rounded-2xl bg-emerald-500/[0.12] border border-emerald-500/25 flex items-center justify-center mx-auto mb-4">
          ...
          <div className="px-5 py-5 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              <button onClick={copyAll}
                className="flex items-center justify-center gap-2 py-3 rounded-xl border border-white/[0.10] hover:border-white/[0.20] text-zinc-300 text-sm transition-all">
        ...
        <a href="/" className="w-full mt-4 py-3 rounded-xl border border-white/[0.08] text-zinc-500 hover:text-zinc-300 text-sm transition-colors block text-center">
          Retour a l'accueil
        </a>
      </div>
    </div>
